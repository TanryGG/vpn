...
router.get('/dashboard', requireAuth, async (req,res)=>{
  ...
  res.render('dashboard',{title:'Кабинет', sub, vpnSub, whiteVpnSub, gptSub, vpn, whiteVpn, usage, qr, whiteQr, vpnSubUrl, whiteVpnSubUrl, profile, refStats, plans, emailChange, trialClaimed});
});
